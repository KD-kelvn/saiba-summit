  ...
  return (
    ...
    <section className="about-section" id="about">
        <div className="grid grid-rows-2 gap-4 sm:grid-rows-1"></div>
          ...
          <div>
              <p>is a gathering of thought leaders, entrepreneurs, and investors in technology industry who are passionate about driving innovation and creating solutions to local problems in Africa.</p>
